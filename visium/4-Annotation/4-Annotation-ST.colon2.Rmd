...
```{r}
DimPlot(Data) + DimPlot(Data, group.by = "SCT_snn_res.0.4")
...
Data@meta.data <- Data@meta.data %>%
    dplyr::mutate(
        annotation_lvl1 = dplyr::case_when(
            SCT_snn_res.0.4 == 0 ~ "Stromal",
            SCT_snn_res.0.4 == 1 ~ "Stromal",
            SCT_snn_res.0.4 == 2 ~ "Epithelial",
            SCT_snn_res.0.4 == 3 ~ "Stromal",
            SCT_snn_res.0.4 == 4 ~ "Epithelial",
            SCT_snn_res.0.4 == 5 ~ "Stromal",
            SCT_snn_res.0.4 == 6 ~ "Epithelial",
            SCT_snn_res.0.4 == 7 ~ "Stromal",
            SCT_snn_res.0.4 == 8 ~ "Stromal",
            SCT_snn_res.0.4 == 9 ~ "Immune",
            SCT_snn_res.0.4 == 10 ~ "Stromal"
