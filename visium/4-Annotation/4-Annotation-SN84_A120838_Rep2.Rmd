...
SpatialDimPlot(Data, pt.size.factor = 2) + 
...
Data@meta.data <- Data@meta.data %>%
    dplyr::mutate(
        annotation_lvl1 = dplyr::case_when(
            SCT_snn_res.0.3 == 0 ~ "Epithelial",
            SCT_snn_res.0.3 == 1 ~ "TME",
            SCT_snn_res.0.3 == 2 ~ "Low_Q",
            SCT_snn_res.0.3 == 3 ~ "Stormal"
