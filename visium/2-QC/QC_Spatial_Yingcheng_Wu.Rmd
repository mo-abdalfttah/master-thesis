...
gem_ls <- c("ST.colon1", "ST.colon2", "ST.colon3", "ST.colon4", "ST.liver1", "ST.liver2", "ST.liver3", "ST.liver4")
Author <- "Yingcheng_Wu"
stutility_plts <- lapply(gem_ls, function(id) {
  
  sample_id <- c("ST.colon1", "ST.colon2", "ST.colon3", "ST.colon4")
  proj_dir <- here::here()
...
sp_ls <- lapply(gem_ls, function(gem_id) {
  ...
  sample_id <- c("ST.colon1", "ST.colon2", "ST.colon3", "ST.colon4", "ST.liver1", "ST.liver2", "ST.liver3", "ST.liver4")
