...
DimPlot(Data, group.by = "SCT_snn_res.0.3", cols =cols)
SpatialDimPlot(Data, pt.size.factor = 2,group.by = "SCT_snn_res.0.3") + 
...
FeaturePlot(Data, features = c("PTPRC", "CD3E", "CD19", "CD14",
  ...
  DimPlot(Data, cols = ggsci::pal_igv()(50), group.by = "SCT_snn_res.0.3") +
...
VlnPlot(Data, features = c("PTPRC", "CD3E", "CD19", "CD14",
                                      ...
                                      "VIM", "FAP", "DCN", "ACTA2")) +
  DimPlot(Data, cols = ggsci::pal_igv()(50), group.by = "SCT_snn_res.0.3") +
  SpatialDimPlot(Data, label = FALSE, pt.size.factor = 2.5, group.by = "SCT_snn_res.0.3") + 
    guides(fill = guide_legend(override.aes = list(size=10))) & 
    scale_fill_manual(values = ggsci::pal_igv()(50))
