...
Data@meta.data <- Data@meta.data %>%
    dplyr::mutate(
        annotation_lvl1 = dplyr::case_when(
            SCT_snn_res.0.4 == 0 ~ "Epithelial",
            SCT_snn_res.0.4 == 1 ~ "Stromal",
            SCT_snn_res.0.4 == 2 ~ "Hepatocytes",
            SCT_snn_res.0.4 == 3 ~ "Epithelial",
            SCT_snn_res.0.4 == 4 ~ "Epithelial",
            SCT_snn_res.0.4 == 5 ~ "Hepatocytes",
            SCT_snn_res.0.4 == 6 ~ "Hepatocytes",
            SCT_snn_res.0.4 == 7 ~ "Hepatocytes",
            )
        )
```
