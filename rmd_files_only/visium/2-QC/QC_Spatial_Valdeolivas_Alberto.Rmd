...
gem_ls <-  c("SN124_A938797_Rep2", "SN123_A595688_Rep1", "SN048_A121573_Rep1", "SN048_A121573_Rep2", "SN84_A120838_Rep2", "SN124_A595688_Rep2")
Author <- "Valdeolivas_Alberto"
stutility_plts <- lapply(gem_ls, function(id) {
  
  sample_id <- c("SN124_A938797_Rep2", "SN123_A595688_Rep1", "SN048_A121573_Rep1", "SN048_A121573_Rep2", "SN84_A120838_Rep2", "SN124_A595688_Rep2" )
  proj_dir <- here::here()
  spaceranger_data <- glue::glue("{spaceranger}/{Author}/{id}/spatial") %>% here::here()
  ...
  infoTable <- data.frame(
    ...
    imgs = glue::glue("{spaceranger_data}/tissue_hires_image.png"),
