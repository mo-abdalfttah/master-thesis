...
FeaturePlot(Data, features = c("EPCAM","magic_LGR5", "LGR5", "EMP1", "MKI67"))
...
SpatialFeaturePlot(Data, features = c("NFkB", "TNFa", "TGFb", "Strom_lvl1", "CAF.CXCL14._lvl2","Topic_5", "YAP-induced-Gregorieff"),
                   ncol = 4,
                   alpha = c(0, 1),
                   crop = F,
                   max.cutoff = "q99") &
